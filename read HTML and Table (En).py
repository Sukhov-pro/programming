...
from selenium.common.exceptions import ElementClickInterceptedException             #If you get error that you cannot click on smth
...
print("Средняя стоимость услуг по всем разделам")                                                                   #Message:program started
                                                                                                                       #Here I try to write only proccess
...
for i in range (first_procedure_number,last_procedure_number+1,1):                                                      #Cycle to read all tables from list "направления" 
    try:                                                                                                                        #Try to click
        ...
        page = driver.find_element_by_tag_name("html")                                                                          #First time I use "FOR" insted pandas and I tryed to read all lines. Pandas make this proccess faster. And I end this work before banner start(after 2.30 min)
